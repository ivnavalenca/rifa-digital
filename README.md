...
Este projeto foi desenvolvido como atividade da disciplina **Processo de
Requisitos de Software (PRS)** e demonstra a aplicação de práticas de
**Engenharia de Requisitos** e **Gestão Ágil (Scrum)**.
...
O sistema foi projetado considerando três perfis principais:
...
O projeto segue práticas de **Scrum**, incluindo:
...
```
  ...
  [Personas](docs/03-personas.md)                 Perfis de usuários do sistema

  [Jornada do                                     Fluxos de uso do sistema
  Usuário](docs/04-jornada-usuario.md)            

  [Arquitetura](docs/05-arquitetura.md)           Estrutura técnica do sistema
